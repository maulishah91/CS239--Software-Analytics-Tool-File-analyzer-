 ...
 * @throws IOException 
    */
   public static void stemWords(String args,String fileName) throws IOException
   {
	...
	// if file doesnt exists, then create it
				...
				FileWriter fw_train = new FileWriter(file_input.getAbsoluteFile());
